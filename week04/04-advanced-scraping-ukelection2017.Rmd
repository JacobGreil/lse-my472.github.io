...
rD <- rsDriver(browser=c("firefox"), port = 1234L)
driver <- rD[["client"]]
...
const_name <- driver$findElement(using = "xpath", value = '/html/body/div[3]/article/div/div[2]/div/figure/figure/div[5]/table/tbody/tr[3]/td[1]/b/span[2]')$getElementText() 
