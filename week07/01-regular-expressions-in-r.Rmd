...
```{r}
current_dir <- "/Users/jacobgreil/Library/Mobile Documents/com~apple~CloudDocs/02_Studium:Ausbildung:Bildung/02_Master/01_LSE/02_Teaching/03_MY472 Data Science/GitHub folder/lse-my472.github.io/week07"
```

Load the txt file into a character vector with `read_file`:

```{r}
sample_text <- read_file(paste(current_dir, "/uol.txt", sep = ""))
```
